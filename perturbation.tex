...
How does the QSSA differ from that Total Quasi Steady State Assumption (TQSSA)? There we use the \textit{total substrate concentration} $S^{hat}$ instead of $S$ \cite{Borghans}, where $S^hat = S + C$.





Khoo et al justified the TQSSA with singular perturbation analysis in 2008. We will now follow their approach.
