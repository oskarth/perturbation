...
forming complex C, $A+B \rightarrow_k C$ are governed by
...
timescales for TQSSA, Borghans et al. use the substitution
$\overline{S} = S + C$ from (64). By doing so, and assuming
$\frac{dC}{dt}=0$ as before, the $\frac{dC}{dt}$ equation gets a
quadratic term
\begin{equation}
...
TQSSA approximation works. Equation (153) is thus
\begin{equation}
