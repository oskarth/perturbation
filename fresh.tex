...
S + C$. By doing so the $dC\dt$ equation gets a $C^2$ - a quadratic -
term. They then use a so called two-point Padé approximant to simplify
the resulting expression, eventually ending up with these two slightly
