...
If we have assume there are two roots $x_1$ and $x_2$, then the
quadratic equation $x^2+bx+c$ can be factored into $(x - x_1)(x -
x_2)$, where:
\begin{equation}
  x_1 x_2 = c
\end{equation}
...
satisfies the conservation law (58), $E + C = E_0$
